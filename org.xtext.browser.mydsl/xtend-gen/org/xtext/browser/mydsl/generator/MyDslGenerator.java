...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final Open o, final int index) {
    ...
    _builder.newLine();
    _builder.append("System.setProperty(\"webdriver.chrome.driver\", \"D:/Documents/EMN/FILA3/Dedies/12-11/chromedriver.exe\");");
    _builder.newLine();
    _builder.append("ChromeOptions options = new ChromeOptions();");
    _builder.newLine();
    _builder.append("WebDriver driver = new ChromeDriver(options);");
    _builder.newLine();
  ...
  public CharSequence compile(final Contains c, final int index) {
    ...
    }
    {
      ...
      boolean _equals_3 = Objects.equal(_type_2, "Text");
      if (_equals_3) {
        _builder.append("//");
